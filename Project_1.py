...
for filename in os.listdir("\Users\Libby\Documents\Spring 2017\Comp_Methods"):
    i=0
    ##define image
    ...
    ##Save data in folder
    np.savetxt("C:\\Users\\Libby\\Desktop\\Binary_Data\\" + os.path.splitext(filename) [0] + ".txt", river, fmt = '%d')
